...
template <typename T, class CMP>
conjunto<T, CMP>::const_impar_iterator::const_impar_iterator
		(const typename conjunto<T,CMP>::const_impar_iterator &  x){
	this->it=x.it;
...
const typename conjunto<T,CMP>::value_type &
			 conjunto<T, CMP>::const_impar_iterator::operator*()
{
	return *it;
}
...
template <typename T, class CMP>
bool conjunto<T,CMP>::const_impar_iterator::operator==
		(const typename conjunto<T,CMP>::const_impar_iterator & x) const {
	return this->it==x.it;
}
...
template <typename T, class CMP>
typename conjunto<T,CMP>::const_impar_iterator & 
		conjunto<T,CMP>::const_impar_iterator::operator=(const typename conjunto<T,CMP>::const_impar_iterator & x){
	this->it=x.it;
	this->elvector=x.elvector;
	return (*this);
}